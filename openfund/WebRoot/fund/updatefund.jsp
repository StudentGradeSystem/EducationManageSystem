...
<html>
	...
	<body>
        ...
        <%
         ...
         %>
		<form action="fund?type=6" method="post" id="form"
			...
			<div class="control-group">
				...
				<div class="controls">
					<!--  <input type="text" name="fundName" id="fundName" value="<%=fund.getFundName() %>"/>   -->
                    <s:textfield name="fund.fundName" id="fundName"></s:textfield>					
			...
			<div class="control-group">
				...
				<div class="controls">
					<!-- <input type="text" name="fundPrice" id="fundPrice" value="<%=fund.getFundPrice() %>"/>  -->
			...
			<div class="control-group">
				...
				<div class="controls">
					<!--  <input type="text" name="fundDes" id="fundDes" value="<%=fund.getFundDes() %>"/> -->
			...
			<div class="control-group">
				...
				<!--  
					<select name="fundStatus" id="fundStatus" class="input-medium">
						...
						<option value="Y" 
						<% if(fund.getFundStatus().equals("Y")) out.println("selected");%>  >
							可交易
						</option>
						<option value="N"
						<% if(fund.getFundStatus().equals("N")) out.println("selected");%>  >
							未上市交易
						</option>
					</select>
					-->
			...
			<div class="control-group controls">
			    <!-- <input name="fund.fundNo" type="hidden" value="<%=fund.getFundNo()%>"/>  -->
